...
# Initial processing:
#
#   dpsst_full_processor.sh 2022-07-14
#
# Reprocessing:
#
#   dpsst_full_processor.sh 2022-07-14 again
#
...
do_processing() {
  date_string=$1
  data_project_dir=$2
  input_dir="../dpsst-scraper/full-scraped-cj-iris-data/$date_string"
  ...
  # Purposely commenting out jekyll business until this is ready for github
...
process_directory() {
  date_string=$1
  data_project_dir="../dpsst-full-cj-iris-data"

  do_processing $date_string $data_project_dir

  # Purposely commenting out the tag_commit_push until this is ready for github
